...
@app.api_route("/comment", methods=["GET", "HEAD", "OPTIONS"])
async def comment_other(request: Request):
    return JSONResponse(content={"message": "Use POST method"}, status_code=200)
